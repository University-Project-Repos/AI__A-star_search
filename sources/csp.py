...
functions. This module is specifically written for COSC367 quiz at
...
def scope(constraint):
    """
    Takes a constraint in the form of a function (or lambda expression) and returns the set of formal parameter names.
    """
